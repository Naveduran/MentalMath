    ...
    return (
      <div className="App">
        ...
        <div className="game">
          ...
          <button onClick={()=> {this.checkAnswer(true, total, proposedAnswer); this.updateValues()} }>
            True
          </button>
          <button onClick={()=> {this.checkAnswer(false, total, proposedAnswer); this.updateValues()} }>
            False
          </button>
          <p className="text">
